  ...
  return (
    ...
    >
      ...
      {hasChildren && expanded && (
        // role="group" here follows the WAI-ARIA Authoring Practices
        // Guide's own TreeView pattern for a node's nested children — see
        // the repo's biome.json for why useSemanticElements is off rather
        // than suppressed line by line.
