...
export function Navbar({ className, ...props }: ComponentProps<"header">) {
  return (
    <header
      data-slot="navbar"
      className={cn("flex h-14 shrink-0 items-center gap-4 border-b border-neutral-6 bg-neutral-1 px-4", className)}
      {...props}
    />
  );
}
...
export function NavbarBrand({ className, ...props }: ComponentProps<"div">) {
  return <div data-slot="navbar-brand" className={cn("flex shrink-0 items-center gap-2 text-sm font-semibold text-neutral-12", className)} {...props} />;
}
...
export function NavbarContent({ className, ...props }: ComponentProps<"div">) {
  return <div data-slot="navbar-content" className={cn("flex flex-1 items-center gap-2", className)} {...props} />;
}
...
export function NavbarActions({ className, ...props }: ComponentProps<"div">) {
  return <div data-slot="navbar-actions" className={cn("ml-auto flex shrink-0 items-center gap-2", className)} {...props} />;
}
